...
worldSubRegion1AverageDfNotNaN = worldSubRegion1AverageDf[worldSubRegion1AverageDf["place_id"].notna()]

worldSubRegion1ParksList = create_list_for_json_just_parks(worldSubRegion1AverageDfNotNaN)
